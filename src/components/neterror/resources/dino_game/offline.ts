...
export class Runner implements ImageSpriteProvider, GameStateProvider,
  ...
  private isArcadeMode(): boolean {
    ...
    const isChromeDino =
        IS_RTL ? document.title.indexOf(ARCADE_MODE_URL) === 1 :
                 document.title === ARCADE_MODE_URL;
    const isThoriumDino =
        IS_RTL ? document.title.indexOf(ARCADE_MODE2_URL) === 1 :
                 document.title === ARCADE_MODE2_URL;
    return isChromeDino || isThoriumDino;
  }
